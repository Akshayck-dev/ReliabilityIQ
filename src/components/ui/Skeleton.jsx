...
export const TaskCardSkeleton = () => {
    return (
        <div className="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm border border-slate-200 dark:border-slate-700 pointer-events-none mb-3 last:mb-0">
            <div className="flex items-start gap-2 mb-2">
                <Skeleton className="h-4 w-4 rounded shrink-0" />
                <Skeleton className="h-4 w-3/4" />
            </div>
            <Skeleton className="h-3 w-full mb-1.5 ml-6" />
            <Skeleton className="h-3 w-2/3 mb-3 ml-6" />
