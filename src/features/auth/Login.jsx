...
const Login = () => {
    ...
    if (user) {
        if (!role) return <div className="min-h-screen flex items-center justify-center bg-slate-50">Loading profile...</div>;
        const redirectPath = role === 'manager' ? '/analytics' : '/dashboard';
